...
public class RecoverUser {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RecoverUser window = new RecoverUser();
	...
	private void initialize() {
		...
		btnCancel.setBounds(282, 314, 89, 23);
		...
		JLabel lblAreYouSure = new JLabel("Are you sure to recover this user?");
